...
PROCESS_ENDLESS_COMPLETE_NETWORK_SCAN_NAME = 'endless_complete_network_scan'
...
PROCESS_ENDLESS_ANALYSIS_SCAN_NAME = 'endless_analysis_scan'

SERVICE_LIST = [PROCESS_ENDLESS_COMPLETE_NETWORK_SCAN_NAME,
                ...
                PROCESS_ENDLESS_ANALYSIS_SCAN_NAME]
